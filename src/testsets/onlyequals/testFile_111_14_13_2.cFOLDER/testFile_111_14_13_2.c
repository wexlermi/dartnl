...
main(int argc, char **argv)
{
	...
	int             x12;
	CREST_int(x12);
	if ((-2 * x2 * x4) + (-2 * x7 * x9) + (-2 * x1 * x11) == -88) {
		printf("I am here at depth 14");
		if ((-1 * x2 * x7) + (-1 * x7 * x8) == 108) {
			printf("I am here at depth 13");
			if ((-2 * x4 * x5) + (-1 * x2 * x7) + (1 * x3 * x10) == 206) {
					...
					if ((-204 * x5 * x10) == -14280) {
						...
						if ((2 * x8 * x11) == 80) {
							...
							if (== 0) {
								...
								if ((-2 * x3 * x8) + (-1 * x10 * x10) + (-1 * x7 * x11) == -149) {
									...
									if ((1 * x1 * x4) == 70) {
										...
										if ((1 * x3 * x11) == -27) {
											...
											if ((1 * x1 * x3) == 0) {
												...
												if ((1 * x4 * x5) + (-1 * x5 * x5) + (1 * x1 * x6) == -35) {
													printf("I am here at depth 3");
													if ((1 * x3 * x5) + (-4 * x0 * x6) == -4) {
														printf("I am here at depth 2");
														if ((-1 * x9 * x9) + (1 * x5 * x10) + (-4 * x9 * x12) == 79) {
