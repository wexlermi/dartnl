...
main(int argc, char **argv)
{
	...
	if ((-1 * 1) == -1) {
		...
		if ((2 * x2 * x7) + (6 * x2 * x12) + (-1 * x10 * x18) == -498) {
			printf("I am here at depth 13");
			if ((1 * x4 * x6) + (2 * x14 * x17) == 63) {
				printf("I am here at depth 12");
				if ((4 * x1 * x16) + (-4 * x17 * x18) == 52) {
					printf("I am here at depth 11");
					if ((-4 * x5 * x10) + (5 * x10 * x16) == -252) {
						printf("I am here at depth 10");
						if ((-1 * x8 * x10) + (-3 * x14 * x15) == -199) {
											...
											if ((-2 * x15 * x15) == -162) {
												...
												if ((3 * x17 * x17) == 3) {
													...
													if ((2 * x3) + (-4 * 1) == -2) {
														...
														if ((1 * x3 * x12) + (-1 * x10 * x17) + (23 * x5) == -273) {
