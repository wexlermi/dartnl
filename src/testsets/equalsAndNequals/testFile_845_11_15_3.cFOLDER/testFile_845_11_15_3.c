  ...
  if ((1 * x1 * x11 * x11) != -74)
    {
      ...
      if ((1 * x1 * x6 * x10) + (1 * x8 * x8 * x10) + (-1 * x6 * x12 * x12) ==
	  -456)
	{
	  ...
	  if ((5 * x1 * x7 * x14) != 107)
	      ...
	      if ((-4 * x5 * x7 * x11) == 0)
		{
		  ...
		  if ((-1 * x1 * x8 * x10) + (-2 * x4 * x6 * x13) +
		      (1 * x4 * x8) + (1 * x4 * x9) == 100)
		    {
		      printf ("I am here at depth 7");
		      if ((-3 * x4 * x4 * x8) + (-19 * x1 * x3 * x9) +
			  (-4 * x2 * x5 * x14) == 716)
			{
			  printf ("I am here at depth 6");
			  if ((2 * x4 * x4 * x10) + (1 * x4 * x7 * x12) !=
			      -26)
			    {
			      printf ("I am here at depth 5");
			      if ((1 * x5 * x7 * x7) + (3 * x2 * x9 * x10) +
				  (-4 * x8 * x8 * x14) + (1 * x7 * x9) ==
				  1264)
				{
