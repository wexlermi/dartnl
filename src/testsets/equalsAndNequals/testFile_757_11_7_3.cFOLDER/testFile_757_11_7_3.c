...
// x5 = 3
// x6 = -6
  if ((-5 * x2 * x2 * x3) + (4 * x1 * x3 * x3) + (1 * x0 * x1 * x4) +
      (-4 * x1 * x1 * x5) + (1 * x3 * x6) != -1784)
    {
      printf ("I am here at depth 11");
      if ((-1 * x2 * x2 * x5) + (-1 * x4 * x4) + (-3 * x3 * x5) == -336)
	{
	  printf ("I am here at depth 10");
	  if ((-5 * x5 * x5 * x6) + (1 * x0 * x5) + (1 * x5 * x6) + (2 * 1) !=
	      212)
	    {
	      printf ("I am here at depth 9");
	      if ((-1 * x3 * x3 * x4) + (6 * x1 * x4 * x5) +
		  (-11 * x6 * x6) != -145)
		{
