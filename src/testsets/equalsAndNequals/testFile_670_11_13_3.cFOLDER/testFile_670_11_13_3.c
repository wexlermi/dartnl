...
// x11 = -10
// x12 = 5
  if ((-2 * x3 * x5 * x6) + (-1 * x2 * x3 * x7) + (-1 * x0 * x0 * x12) != -57)
    {
      printf ("I am here at depth 11");
      if ((-9 * x7 * x8 * x8) + (-1 * x4 * x7 * x12) + (5 * x2 * x10 * x12) !=
	  -7748)
	{
	  printf ("I am here at depth 10");
	  if ((-4 * x1 * x3 * x3) + (2 * x9 * x10 * x11) != 164)
	    {
	      printf ("I am here at depth 9");
	      if ((1 * x6 * x7 * x9) + (-6 * x2 * x10 * x10) == 752)
		{
		  printf ("I am here at depth 8");
		  if ((1 * x1 * x4 * x6) + (-2 * x1 * x3 * x8) +
		      (99 * x9 * x9 * x11) + (5 * x12 * x12) == -913)
		    {
		      printf ("I am here at depth 7");
		      if ((1 * x2 * x7 * x9) + (-9 * x3 * x4 * x10) +
			  (2 * x1 * x7 * x11) != -1363)
			{
