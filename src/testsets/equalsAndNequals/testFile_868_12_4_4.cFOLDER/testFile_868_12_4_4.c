...
// x2 = 4
// x3 = -3
  if ((8 * x1 * x1 * x2 * x3) != -6167)
    {
      printf ("I am here at depth 12");
      if ((-11 * x0 * x1 * x2 * x2) + (-5 * x0 * x1) != 12943)
	{
	  printf ("I am here at depth 11");
	  if ((12 * x0 * x1 * x1 * x2) + (1 * x1 * x1 * x1) +
	      (-1 * x3 * x3) != -27053)
	    {
	      printf ("I am here at depth 10");
	      if ((-1 * x1 * x2 * x3 * x3) != -203)
		{
		  printf ("I am here at depth 9");
		  if ((1 * x0 * x0 * x2 * x2) + (-6 * x2 * x2 * x2 * x2) +
		      (-3 * x2 * x2 * x2 * x3) + (1 * x3 * x3 * x3 * x3) +
		      (1 * x0 * x2 * x2) + (8 * x1 * x2 * x3) +
		      (-59 * x2 * x3 * x3) != -2654)
		    {
		      printf ("I am here at depth 8");
		      if ((2 * x0 * x1 * x2 * x2) + (2 * x1 * x3 * x3 * x3) +
			  (1 * x0 * x1 * x1) + (4 * x1 * x1 * x1) +
			  (-1 * x0 * x2 * x2) + (-6 * x1 * x1 * x3) == 32)
			{
			  printf ("I am here at depth 7");
			  if ((-2 * x0 * x1 * x1 * x2) +
			      (2 * x1 * x1 * x2 * x3) +
			      (2 * x0 * x2 * x3 * x3) + (3 * x0 * x1 * x3) +
			      (-43 * x2 * x3 * x3) + (-1 * x1 * x3) +
			      (-1 * x2) != 1633)
			    {
