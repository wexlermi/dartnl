...
// x13 = 10
// x14 = -5
  if ((-1 * x6 * x9 * x10) + (-1 * x10 * x10 * x10) + (1 * x0 * x0 * x12) !=
      -1)
    {
      printf ("I am here at depth 12");
      if ((-8 * x3 * x3 * x3) + (-1 * x1 * x3 * x8) + (1 * x6 * x8 * x8) +
	  (3 * x8 * x13 * x14) + (-1 * x8) == -834)
	{
	  printf ("I am here at depth 11");
	  if ((-1 * x2 * x4 * x5) != -73)
	    {
	      printf ("I am here at depth 10");
	      if ((5 * x3 * x5 * x5) + (3 * x0 * x9 * x14) + (1 * x4 * x9) ==
		  32)
		{
		  printf ("I am here at depth 9");
		  if ((4 * x1 * x7 * x7) + (3 * x7 * x12 * x13) +
		      (-1 * x6 * x10 * x14) + (-6 * x0 * x0) != 1023)
		    {
		      printf ("I am here at depth 8");
		      if ((1 * x0 * x6 * x13) + (-1 * x5 * x7 * x13) != -454)
			{
