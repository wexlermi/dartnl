...
// x7 = -5
// x8 = 9
  if ((3 * x1 * x2 * x8) + (3 * x0 * x7) != -327)
    {
      printf ("I am here at depth 10");
      if ((2 * x8) != 114)
	{
	  printf ("I am here at depth 9");
	  if ((-1 * x3 * x5 * x6) + (-1 * x7 * x8 * x8) != 785)
	    {
	      printf ("I am here at depth 8");
	      if ((1 * x1 * x4 * x5) + (1 * x0 * x2) != -60)
		{
		  printf ("I am here at depth 7");
		  if ((-2 * x3 * x4 * x6) + (4 * x1 * x7 * x7) +
		      (4 * x0 * x1) + (1 * x1 * x7) != 759)
		    {
		      ...
		      if ((-1 * x7 * x7 * x8) != -296)
			{
			  ...
			  if ((7 * x3 * x4 * x6) + (-2 * x3 * x6 * x6) ==
			      1800)
			    {
			      printf ("I am here at depth 4");
			      if ((1 * x2 * x5 * x5) + (-1 * x4 * x5 * x5) +
				  (3 * x1 * x8) != 137)
				{
				  printf ("I am here at depth 3");
				  if ((1 * x0 * x4 * x6) + (-3 * x5 * x8) !=
				      138)
				    {
