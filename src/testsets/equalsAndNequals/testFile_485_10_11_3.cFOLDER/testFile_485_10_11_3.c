...
// x9 = -7
// x10 = 9
  if ((1 * x2 * x4 * x5) + (-1 * x3 * x6 * x6) + (-1 * x3 * x3 * x8) +
      (-8 * x0 * x10 * x10) != -3138)
    {
      ...
      if ((7 * x4 * x6 * x7) == -210)
	{
	  ...
	  if ((1 * x0 * x0 * x7) + (-4 * x2 * x8 * x8) +
	      (17 * x0 * x1 * x10) + (-1 * x2 * x7 * x10) != 5014)
	    {
	      printf ("I am here at depth 8");
	      if ((-2 * x2 * x3 * x7) + (70 * x4 * x9 * x9) + (24 * x8 * x9) +
		  (2 * x10 * x10) != -19535)
		{
		  ...
		  if ((-1 * x2 * x5) != -29)
		      ...
		      if ((-1 * x0 * x3) == -50)
			{
			  ...
			  if ((1 * x0 * x6 * x7) + (-2 * x0 * x1) != 56)
			    {
			      printf ("I am here at depth 4");
			      if ((2 * x1 * x1 * x3) + (6 * x2 * x4 * x10) +
				  (1 * x7 * x10) + (1 * x10) != 3434)
				{
