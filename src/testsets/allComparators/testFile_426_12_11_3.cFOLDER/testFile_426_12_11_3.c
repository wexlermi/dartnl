...
// x9 = 8
// x10 = -3
  if ((2 * x0 * x3 * x8) + (-2 * x9) > -640)
    {
      printf ("I am here at depth 12");
      if ((-1 * x1 * x2 * x4) + (-1 * x0 * x1 * x5) + (2 * x0 * x8 * x8) +
	  (1 * x7 * x10 * x10) != 1815)
	{
	  printf ("I am here at depth 11");
	  if ((-4 * x2 * x4 * x7) + (-6 * x4 * x5 * x8) +
	      (-1 * x5 * x7 * x8) + (1 * x1 * x3 * x9) + (1 * x4) != 681)
	    {
		  ...
		  if ((14 * x3 * x3 * x3) == 896)
		    {
		      ...
		      if ((1 * x6 * x7 * x7) + (1 * x6 * x7 * x10) +
			  (15 * x4 * x8 * x10) + (4 * x1 * x1) +
			  (14 * x10 * x10) != -728)
			{
			  printf ("I am here at depth 7");
			  if ((1 * x2 * x3 * x5) + (1 * x5 * x5 * x7) +
			      (-1 * x0 * x1 * x8) + (-11 * x0 * x7 * x9) >
			      -3256)
			    {
			      printf ("I am here at depth 6");
			      if ((69 * x0 * x4 * x6) + (8 * x8 * x9 * x10) ==
				  8988)
				{
