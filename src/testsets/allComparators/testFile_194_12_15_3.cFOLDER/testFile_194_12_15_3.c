...
// x13 = 5
// x14 = 5
  if ((-1 * x2 * x11 * x12) + (1 * x3 * x8 * x14) == 30)
    {
      printf ("I am here at depth 12");
      if ((1 * x6 * x8 * x9) + (-1 * x1 * x3) + (-8 * x6 * x12) > -25)
	{
	  printf ("I am here at depth 11");
	  if ((1 * x2 * x5 * x9) + (-1 * x10 * x10 * x12) + (1 * x1) > 41)
	    {
	      printf ("I am here at depth 10");
	      if ((-3 * x2 * x7 * x12) + (1 * x2 * x6) + (6 * x0 * x14) >
		  -781)
		{
		  printf ("I am here at depth 9");
		  if ((-1 * x2 * x4 * x4) + (2 * x2 * x5 * x13) <= 131)
		    {
		      printf ("I am here at depth 8");
		      if ((2 * x0 * x1 * x11) != -498)
			{
			  printf ("I am here at depth 7");
			  if ((4 * x0 * x4 * x5) + (5 * x5 * x7 * x11) +
			      (-1 * x2 * x7) == 3290)
			    {
