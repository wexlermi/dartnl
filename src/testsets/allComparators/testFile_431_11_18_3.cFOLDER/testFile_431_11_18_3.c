...
// x16 = -6
// x17 = 5
  if ((-1 * x4 * x5 * x10) + (1 * x1 * x5 * x17) != 291)
    {
      printf ("I am here at depth 11");
      if ((4 * x3 * x3 * x6) + (-1 * x4 * x5 * x10) + (-2 * x0 * x12 * x17) <=
	  -714)
	{
	  printf ("I am here at depth 10");
	  if ((-1 * x0 * x1 * x1) + (5 * x1 * x12 * x12) +
	      (-1 * x16 * x16 * x17) + (1 * 1) < 822)
	    {
	      printf ("I am here at depth 9");
	      if ((-1 * x1 * x4 * x11) + (-1 * x2 * x8 * x15) +
		  (-18 * x8 * x14) >= 308)
		{
		  ...
		  if ((-1 * x3 * x5 * x14) > 243)
		    {
		      ...
		      if ((1 * x0 * x1 * x3) + (-4 * x1 * x8 * x11) +
			  (7 * x10 * x11 * x13) + (-1 * x13 * x15 * x16) +
			  (-10 * x0 * x13 * x17) >= -469)
			{
			  printf ("I am here at depth 6");
			  if ((-1 * x1 * x5 * x15) + (-3 * x5 * x8 * x15) +
			      (1 * x4 * x9 * x16) + (1 * x5 * x11 * x16) +
			      (-1 * x4 * x8) < -123)
			    {
