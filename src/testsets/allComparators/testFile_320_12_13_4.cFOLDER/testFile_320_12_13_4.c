...
// x11 = 10
// x12 = 0
  if ((3 * x1 * x1 * x1 * x11) < -797)
    {
      printf ("I am here at depth 12");
      if ((-1 * x0 * x2 * x2 * x8) + (26 * x1 * x1 * x7 * x10) +
	  (-2 * x0 * x5 * x9 * x12) + (-1 * x6 * x8 * x10 * x12) < 10473)
	{
	  printf ("I am here at depth 11");
	  if ((1 * x3 * x5 * x9) == 36)
	    {
	      printf ("I am here at depth 10");
	      if ((-2 * x2 * x5 * x5 * x6) + (8 * x4 * x9 * x9 * x9) +
		  (-1 * x5 * x8 * x8 * x12) + (-3 * x0 * x2 * x9 * x12) +
		  (1 * x1 * x4 * x11 * x12) + (1 * x0 * x9) > 13877)
		{
		  printf ("I am here at depth 9");
		  if ((212 * x9 * x9 * x10 * x12) > -20)
		    {
		      printf ("I am here at depth 8");
		      if ((-1 * x2 * x3 * x8 * x9) +
			  (1 * x2 * x2 * x5 * x10) +
			  (1 * x0 * x7 * x10 * x10) +
			  (-1 * x0 * x9 * x11 * x11) + (4 * x6 * x10 * x11) ==
			  -1360)
			{
