...
// x6 = -10
// x7 = 3
  if ((9 * x4 * x4 * x4) + (-6 * x4 * x5 * x6) + (-1 * x3 * x3) == 2975)
    {
      printf ("I am here at depth 13");
      if ((-1 * x0 * x3 * x5) + (1 * x1 * x4 * x5) + (-1 * x0 * x3) <= -1322)
	{
	  printf ("I am here at depth 12");
	  if ((1 * x1 * x2 * x3) + (-1 * x2 * x3 * x3) + (-2 * x3 * x4 * x5) +
	      (1 * x0 * x7 * x7) + (-1 * x5 * x7) < 1143)
	    {
	      printf ("I am here at depth 11");
	      if ((-1 * x4 * x4 * x4) + (-1 * x0 * x0 * x6) + (3 * x1 * x6) <
		  -187)
		{
		  ...
		  if ((1 * x0 * x0 * x6) != -907)
		    {
		      ...
		      if ((6 * x1 * x1 * x1) + (-10 * x0 * x3 * x5) >= -707)
			{
			  printf ("I am here at depth 8");
			  if ((2 * x1 * x3 * x3) + (1 * x2 * x2 * x4) +
			      (-4 * x1 * x4 * x5) + (1 * x6 * x6 * x6) +
			      (-128 * x6 * x6 * x7) < -34490)
			    {
			      printf ("I am here at depth 7");
			      if ((-2 * x1 * x5 * x6) + (2 * x1 * x7 * x7) <
				  -1573)
				{
