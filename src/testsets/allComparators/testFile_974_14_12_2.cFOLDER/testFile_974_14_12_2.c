			  ...
			  -54)
			{
			  ...
			  if ((-16 * x9 * x11) != -132)
			      ...
			      if ((-1 * x7 * x10) + (1 * x3) <= 31)
				{
				  ...
				  if ((2 * x3 * x3) + (-1 * x8 * x10) < 136)
				    {
				      printf ("I am here at depth 6");
				      if ((-12 * x1 * x5) + (-4 * x4 * x11) >=
					  -776)
					{
