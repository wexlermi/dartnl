  ...
  if ((-22 * x1 * x1) <= -80)
    {
	  ...
	  (-11 * x0 * x1 * x1 * x1) + (-9 * x1 * x1 * x1 * x1) +
	  (3 * x0 * x0 * x1 * x2) + (-1 * x0 * x1 * x1 * x2) +
	  (-2 * x0 * x0 * x2 * x2) + (2 * x0 * x1 * x2 * x2) +
	  (-2 * x1 * x1 * x2 * x2) <= -1613)
	{
	  printf ("I am here at depth 11");
	  if ((1 * x1 * x1 * x1 * x2) + (-1 * x1 * x1 * x2 * x2) +
	      (1 * x2 * x2 * x2 * x2) + (1 * x0 * x0 * x1) + (-20 * x1 * x1) +
	      (6 * x0 * x2) < 1561)
	    {
	      printf ("I am here at depth 10");
	      if ((1 * x0 * x0 * x0 * x1) + (-4 * x0 * x0 * x1 * x2) +
		  (5 * x1 * x1 * x1) == -2008)
		{
		  printf ("I am here at depth 9");
		  if ((12 * x0 * x0 * x0 * x1) <= 12346)
		    {
		      printf ("I am here at depth 8");
		      if ((-1 * x0 * x1 * x1 * x2) + (1 * x1 * x1 * x1 * x2) +
			  (-16 * x2 * x2 * x2 * x2) + (1 * x0 * x0 * x1) +
			  (1 * x0 * x0 * x2) + (-1 * x0 * x1 * x2) +
			  (9 * x0 * x0) + (-1 * x0) < -19874)
			{
			  printf ("I am here at depth 7");
			  if ((1 * x0 * x0 * x0 * x1) +
			      (2 * x0 * x1 * x1 * x2) + (1 * x1 * x2 * x2) <
			      1571)
			    {
