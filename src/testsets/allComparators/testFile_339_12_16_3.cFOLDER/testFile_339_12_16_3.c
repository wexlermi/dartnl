...
// x14 = 2
// x15 = 6
  if ((1 * x0 * x3 * x3) + (-2 * x3 * x3 * x4) + (-2 * x0 * x9 * x11) +
      (-2 * x6 * x15) == 1376)
    {
      printf ("I am here at depth 12");
      if ((2 * x10 * x10 * x12) > -107)
	{
	  printf ("I am here at depth 11");
	  if ((1 * x3 * x5 * x5) + (-4 * x5 * x6 * x7) +
	      (-2 * x0 * x5 * x12) + (-9 * x1 * x2 * x13) +
	      (-1 * x10 * x12 * x14) + (-15 * x8 * x10) != 348)
	    {
	      printf ("I am here at depth 10");
	      if ((-2 * x2 * x7 * x11) + (-8 * x4 * x9 * x14) +
		  (-1 * x13 * x14 * x14) != 341)
		{
		  printf ("I am here at depth 9");
		  if ((1 * x4 * x5 * x7) + (3 * x3 * x14 * x14) +
		      (1 * x11 * x13) == -271)
		    {
		      printf ("I am here at depth 8");
		      if ((1 * x0 * x0 * x7) + (-8 * x5 * x10 * x12) +
			  (2 * x5 * x5 * x13) + (2 * x10 * x12 * x13) <= 365)
			{
			  printf ("I am here at depth 7");
			  if ((-1 * x2 * x9 * x15) == 36)
			    {
			      printf ("I am here at depth 6");
			      if ((2 * x5 * x10 * x10) + (1 * x0 * x9 * x11) +
				  (-13 * x1 * x3 * x14) +
				  (2 * x6 * x6 * x15) >= 511)
				{
