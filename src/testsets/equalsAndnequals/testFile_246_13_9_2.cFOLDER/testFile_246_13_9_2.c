	...
	if ((-4 * x8) == 8) {
		...
		if ((5 * x1 * x5) == 0) {
			...
			if ((1 * x0 * x1) == 3) {
				...
				if ((-1 * x2 * x2) + (1 * x7 * x7) != 127) {
					printf("I am here at depth 10");
					if ((-1 * x0 * x6) + (-5 * x3 * x7) == 74) {
						printf("I am here at depth 9");
						if ((-1 * x2 * x2) + (-11 * x2 * x5) + (-1 * x6) != 222) {
							printf("I am here at depth 8");
							if ((-2 * x2 * x4) + (11 * x2 * x7) + (2 * x7 * x7) != 509) {
								printf("I am here at depth 7");
								if ((2 * x8) == 12) {
									printf("I am here at depth 6");
									if ((6 * x4 * x5) + (-1 * x2) != 85) {
										printf("I am here at depth 5");
										if ((1 * x3 * x4) + (-219 * x4 * x8) + (-2 * x8) == -1782) {
											printf("I am here at depth 4");
											if ((1 * x2) == 1) {
												printf("I am here at depth 3");
												if ((-1 * x4 * x5) + (-7 * x7 * x7) + (1 * x7) != -172) {
