...
// x1 = 9
// x2 = 3
  if ((1 * x0 * x1 * x1 * x2) + (2 * x1 * x1 * x2 * x2) == 3159)
    {
      printf ("I am here at depth 11");
      if ((-3 * x0 * x1 * x1 * x2) + (3 * x0 * x2 * x2 * x2) +
	  (-1 * x0 * x0 * x1) + (-153 * x1 * x1 * x2) + (-2 * x0 * x2 * x2) +
	  (1 * x1 * x2 * x2) + (-1 * x1 * x1) == -42282)
	{
	  printf ("I am here at depth 10");
	  if ((3 * x0) == 21)
	    {
	      printf ("I am here at depth 9");
	      if ((2 * x1 * x1 * x2 * x2) + (-9 * x0 * x0 * x2) == 135)
		{
		  printf ("I am here at depth 8");
		  if ((12 * x0 * x0 * x1 * x1) + (-1 * x0 * x0 * x0) +
		      (1 * x0 * x2) + (-1 * x1 * x2) == 47279)
		    {
		      printf ("I am here at depth 7");
		      if ((-1 * x1 * x2 * x2 * x2) + (2 * x0 * x1) +
			  (-1 * x0) == -124)
			{
			  printf ("I am here at depth 6");
			  if ((1 * x0 * x0 * x2 * x2) + (1 * x0 * x2) +
			      (-4 * x1) + (1 * x2) == 429)
			    {
