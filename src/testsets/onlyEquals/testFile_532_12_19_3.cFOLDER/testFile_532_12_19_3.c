  ...
  if ((-11 * x1 * x2 * x5) == -396)
    {
      ...
      if ((-1 * x3 * x3 * x16) + (-3 * x1 * x1 * x18) == 104)
	{
	  printf ("I am here at depth 11");
	  if ((-1 * x0 * x0 * x4) + (-1 * x5 * x9 * x10) +
	      (-2 * x5 * x12 * x14) + (-2 * x7 * x11 * x16) +
	      (-1 * x7 * x16 * x18) == 72)
	    {
	      printf ("I am here at depth 10");
	      if ((-2 * x0 * x3 * x8) + (-6 * x1 * x4 * x10) +
		  (1 * x0 * x6 * x17) + (14 * x3 * x12) == 22)
		{
		  printf ("I am here at depth 9");
		  if ((-69 * x1 * x8 * x15) + (-1 * x8 * x8 * x15) +
		      (1 * x6 * x9 * x17) + (2 * x8 * x8 * x18) == 10564)
		    {
		      printf ("I am here at depth 8");
		      if ((2 * x0 * x13 * x14) + (-1 * x9 * x14 * x14) ==
			  -162)
			{
			  printf ("I am here at depth 7");
			  if ((-1 * x0 * x0 * x2) + (1 * x0 * x4 * x10) +
			      (3 * x6 * x10 * x12) + (-1 * x13 * x16 * x17) +
			      (1 * x4 * x11) == -365)
			    {
			      printf ("I am here at depth 6");
			      if ((-2 * x2 * x2 * x5) + (13 * x4 * x4 * x6) +
				  (-2 * x3 * x15 * x16) +
				  (2 * x7 * x10 * x18) == 120)
				{
