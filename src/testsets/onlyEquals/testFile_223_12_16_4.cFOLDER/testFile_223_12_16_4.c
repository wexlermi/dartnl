  ...
  if ((6 * x1 * x12 * x13) == 0)
    {
      ...
      if ((-85 * x3 * x7 * x11 * x11) + (-2 * x1 * x7 * x10 * x14) +
	  (-7 * x3 * x6 * x13) == -776)
	{
	  printf ("I am here at depth 11");
	  if ((-1 * x0 * x1 * x11 * x13) + (1 * x7 * x12 * x13 * x14) == 0)
	    {
	      printf ("I am here at depth 10");
	      if ((1 * x6 * x7 * x11) + (-1 * x0 * x14) == -16)
		{
		  printf ("I am here at depth 9");
		  if ((1 * x0 * x0 * x4 * x5) + (-1 * x1 * x3 * x10 * x14) +
		      (3 * x1 * x2 * x8 * x15) + (1 * x4 * x11 * x12 * x15) +
		      (3 * x12 * x13 * x13) + (26 * x1 * x1) == -426)
		    {
		      printf ("I am here at depth 8");
		      if ((-1 * x1 * x1 * x4 * x4) +
			  (-1 * x3 * x3 * x9 * x11) +
			  (-1 * x0 * x3 * x7 * x13) +
			  (-1 * x3 * x6 * x13 * x14) + (-25 * x1 * x1 * x10) +
			  (-1 * x11 * x11 * x12) + (-2 * x2 * x6 * x14) ==
			  2191)
			{
