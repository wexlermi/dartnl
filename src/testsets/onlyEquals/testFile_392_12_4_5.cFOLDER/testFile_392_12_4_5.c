...
// x2 = 8
// x3 = 6
  if ((-1 * x0 * x0 * x1 * x2 * x2) == 16000)
    {
      printf ("I am here at depth 12");
      if ((-3 * x1 * x1 * x1 * x1 * x2) + (1 * x1 * x1 * x1 * x1) +
	  (1 * x1 * x1 * x2 * x2) == -223600)
	{
	  printf ("I am here at depth 11");
	  if ((-3 * x0 * x0 * x2 * x3) + (7 * x0 * x0 * x3 * x3) == 2700)
	    {
	      ...
	      if ((-1 * x2 * x2 * x3) == -384)
		{
		  ...
		  if ((-3 * x1 * x1 * x1 * x2 * x2) +
		      (1 * x0 * x1 * x2 * x2 * x2) +
		      (-3 * x2 * x2 * x2 * x3 * x3) +
		      (5 * x1 * x1 * x3 * x3) + (1 * x0 * x3 * x3) +
		      (-1 * x3) == 180118)
		    {
		      printf ("I am here at depth 8");
		      if ((-22 * x1 * x1 * x2 * x2 * x3) +
			  (65 * x0 * x0 * x0 * x2) == -909800)
			{
			  ...
			  if ((2 * x0 * x1 * x1 * x1) +
			      ...
			      (1 * x2 * x2 * x2 * x2) +
			      (1 * x0 * x2 * x3 * x3) +
			      (1 * x3 * x3 * x3 * x3) + (5 * x0 * x0 * x2) +
			      (-1 * x1 * x2 * x2) + (-1 * x0 * x1 * x3) ==
			      -6708)
			    {
