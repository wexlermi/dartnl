...
// x8 = 8
// x9 = -8
  if ((2 * x0 * x5 * x8 * x8) + (-9 * x8 * x8 * x8) == -17408)
    {
      printf ("I am here at depth 10");
      if ((5 * x3 * x3 * x5 * x7) + (-1 * x2 * x3 * x6 * x7) +
	  (1 * x6 * x6 * x6 * x7) + (1 * x0 * x5 * x7 * x7) +
	  (-2 * x0 * x7) == 2806)
	{
	  printf ("I am here at depth 9");
	  if ((-1 * x1 * x2 * x2 * x7) + (-1 * x2 * x5 * x6 * x9) +
	      (6 * x0 * x9) == -2340)
	    {
	      ...
	      if ((4 * x6) == 28)
		{
		  ...
		  if ((-9 * x2 * x6 * x6 * x9) == 10584)
		    {
		      printf ("I am here at depth 6");
		      if ((-1 * x0 * x2 * x2 * x3) +
			  (-1 * x1 * x1 * x2 * x4) + (3 * x2 * x3 * x6 * x6) +
			  (1 * x3 * x3 * x4 * x7) == 2850)
			{
