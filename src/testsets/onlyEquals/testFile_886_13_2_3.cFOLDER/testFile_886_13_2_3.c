...
// x0 = 0
// x1 = 0
  if ((-1 * x0 * x1 * x1) + (-7 * x0 * x0) + (-20 * x0 * x1) == 0)
    {
      printf ("I am here at depth 13");
      if ((1 * x0 * x0 * x1) + (-1 * x0 * x1 * x1) + (1 * x1 * x1 * x1) +
	  (-6 * x1 * x1) + (1 * 1) == 1)
	{
	  printf ("I am here at depth 12");
	  if ((2 * x0 * x0 * x1) + (-9 * x1 * x1 * x1) + (-2 * x0 * x0) +
	      (2 * x0 * x1) + (1 * x1) == 0)
	    {
		  ...
		  if ((-1 * x0 * x0 * x1) + (-1 * 1) == -1)
		    {
		      ...
		      if ((1 * x0 * x0 * x0) + (9 * x0 * x1) + (3 * x1 * x1) +
			  (14 * x0) == 0)
			{
			  printf ("I am here at depth 8");
			  if ((-19 * x0 * x0 * x1) + (1 * x1 * x1 * x1) +
			      (1 * x1 * x1) == 0)
			    {
			      printf ("I am here at depth 7");
			      if ((1 * x0 * x0 * x1) + (-1 * x1 * x1 * x1) +
				  (1 * x0 * x1) + (1 * x0) == 0)
				{
				  printf ("I am here at depth 6");
				  if ((2 * x0 * x0 * x1) + (-8 * x1 * x1) +
				      (1 * x0) + (-2 * 1) == -2)
				    {
