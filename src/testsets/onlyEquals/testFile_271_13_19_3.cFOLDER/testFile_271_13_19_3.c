...
// x17 = -8
// x18 = 6
  if ((-3 * x1 * x9 * x11) + (-2 * x0 * x10) == 56)
    {
      printf ("I am here at depth 13");
      if ((-70 * x0 * x5 * x8) + (-3 * x4 * x9 * x11) + (2 * x0 * x15 * x17) +
	  (1 * x10 * x10) == -7780)
	{
	  printf ("I am here at depth 12");
	  if ((5 * x1 * x3 * x4) + (1 * x8 * x9 * x13) +
	      (-1 * x6 * x11 * x14) == 51)
	    {
	      printf ("I am here at depth 11");
	      if ((-1 * x3 * x11 * x12) + (1 * x5 * x9 * x13) == 266)
		{
		  printf ("I am here at depth 10");
		  if ((2 * x0 * x3 * x10) + (-10 * x1 * x5 * x17) +
		      (14 * x10 * x11) == -676)
		    {
		      printf ("I am here at depth 9");
		      if ((18 * x2 * x4 * x4) + (-1 * x2 * x5 * x5) == -3504)
			{
			  printf ("I am here at depth 8");
			  if ((-2 * x2 * x7 * x7) + (1 * x1 * x6 * x8) +
			      (2 * x3 * x5 * x10) + (-2 * x4 * x8 * x18) +
			      (-1 * x1 * x12 * x18) == -243)
			    {
