...
// x8 = 3
// x9 = 6
  if ((2 * x3 * x7) + (-1 * x9 * x9) == -136)
    {
      printf ("I am here at depth 10");
      if ((-1 * x1 * x4 * x4) + (6 * x0 * x0 * x7) + (-2 * x2 * x3 * x7) +
	  (2 * x4 * x5 * x7) == -702)
	{
	  printf ("I am here at depth 9");
	  if ((1 * x1 * x6 * x6) + (-1 * x0 * x3 * x7) == -325)
	    {
	      printf ("I am here at depth 8");
	      if ((1 * x3 * x5 * x5) + (15 * x4) == 270)
		{
		  printf ("I am here at depth 7");
		  if ((5 * x3 * x3 * x4) + (2 * x1 * x9 * x9) +
		      (4 * x7 * x8) + (-1 * x1 * x9) == -3258)
		    {
		      printf ("I am here at depth 6");
		      if ((-5 * x8 * x8) == -45)
			{
			  printf ("I am here at depth 5");
			  if ((1 * x1 * x1 * x4) + (-1 * x6 * x7 * x9) +
			      (1 * x3 * x8) + (1 * x9) == -168)
			    {
