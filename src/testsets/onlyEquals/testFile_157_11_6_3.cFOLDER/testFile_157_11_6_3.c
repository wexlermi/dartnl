...
// x4 = 2
// x5 = 8
  if ((4 * x0 * x0 * x2) + (-34 * x0 * x2 * x5) + (1 * x1 * x2 * x5) +
      (-1 * x2) + (-1 * x4) == 13837)
    {
	  ...
	  if ((-1 * x1 * x1 * x5) == -392)
	    {
	      ...
	      if ((-1 * x0 * x3 * x5) + (1 * x3 * x3) + (6 * x4 * x4) +
		  (6 * x5) == 648)
		{
		  printf ("I am here at depth 8");
		  if ((1 * x1 * x2 * x4) + (-1 * x2 * x3 * x4) +
		      (-1 * x0 * x4) == -30)
		    {
		      printf ("I am here at depth 7");
		      if ((-1 * x0 * x0 * x2) + (11 * x2 * x3 * x3) == -4480)
			{
			  printf ("I am here at depth 6");
			  if ((1 * x1 * x1 * x3) + (-7 * x2 * x3 * x4) +
			      (-1 * x2 * x5 * x5) + (-2 * x3 * x3) +
			      (1 * x0) == -848)
			    {
			      printf ("I am here at depth 5");
			      if ((3 * x3 * x3 * x3) + (-8 * x0 * x1 * x5) +
				  (-1 * x1 * x2 * x5) + (-1 * x3 * x5 * x5) +
				  (2 * x0) == 2184)
				{
