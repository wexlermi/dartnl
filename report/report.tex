...
what it cannot  or just partially do. We will discuss its limitations
through the following subsections. Here, we will only discuss
limitations that are independent from the solving technique used. The
theoretical and practical limitations of that are subject of section \ref{sctn:Z3}.
...
evaluation.
%TODO: Instrument CREST Z3 to work with double or floats?
